...
class RomanizationMethods(str, Enum):
    ...
    ISO_15919 = "ISO-15919 - Utilize the ISO 15919 standard for Hindi romanization. Ensure precise representation with appropriate diacritics for accurate transliteration of the Devanagari script."
...
class LanguagePairs(tuple[LanguageNames, RomanizationMethods]):
    ...
    HINDI = (LanguageNames.HINDI, RomanizationMethods.ISO_15919)
